...
const debug = _debug('app:server:material')
...
export default class Material extends Base {
    ...
    async addMaterial (filepath, type) {
        var url = "https://api.weixin.qq.com/cgi-bin/material/add_material?access_token=ACCESS_TOKEN&type=TYPE".replace(/TYPE/g, type);
